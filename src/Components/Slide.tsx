...
const Slide:FC<SlideProps> = (props) => {
  ...
  const PlusButtonHundler = () => {
    SetItemCount(ItemCount + 1 );
  }

  const MinusButtonHundler = () => {
    if (ItemCount > 0) {
      SetItemCount(ItemCount - 1 );
    }
  }

  const LoveButtonHundler = () => {
alert('added to fav');
  }

  const AddToCartButtonHundler = () => {
    alert('added to cart');
  }
  ...
  return (
    <div className='Slide'>
    <CircularProgressBar SoldNumber={props.SoldCount} OutOfNumber={props.TotalCount} />
